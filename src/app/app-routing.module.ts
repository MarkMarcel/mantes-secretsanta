...
export const RoutePaths = {
  'home':'',
  'auth':'auth',
  'addItemWanted':'add-item-wanted/:exchangeId',
...
const routes: Routes = [
  ...
  { path: RoutePaths.addItemWanted, component: AddItemWantedComponent, canActivate: [AuthGuard], data: { authGuardPipe: redirectUnauthorizedToLogin },title:'Add Item Wanted' },
